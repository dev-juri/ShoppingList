...
class MainActivity : AppCompatActivity(), onShopItemClickListener {
    ...
    private fun addShopItems() {
        shopList.add(
            ShopList(
                "Fashion Shoe", "#5,850", "Lace up Casual Sneakers\nAvailable in Black and Brown",
                R.drawable.shoe
            )
        )
        shopList.add(
            ShopList(
                "Analog Watch", "#7,500", "Unique Men's 3ATM\nWater Resistant Luxury Analog Watch",
                R.drawable.digitalwatch
            )
        )
        shopList.add(
            ShopList(
                "Polo and Cap", "#3,290", "27 Polo & Cap Bundle\nAvailable in wine and white",
